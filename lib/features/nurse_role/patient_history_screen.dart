...
class _PatientHistoryScreenState extends State<PatientHistoryScreen> {
  final List<Map<String, dynamic>> _historyTimeline = [
    {
      'type': 'vitals',
      'title': 'Vitals Update',
      'time': '09:45 AM',
        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemCount: _historyTimeline.length,
              itemBuilder: (context, index) {
                final item = _historyTimeline[index];
                return Stack(
                  children: [
                    if (index != _historyTimeline.length - 1)
                      Positioned(
                        top: 40,
                        left: 23,
                        bottom: 0,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      if (item['type'] == 'vitals') ...[
                                        ...
                                        Row(
                                          children: [
                                            _buildVitalMetric('TEMP', item['temp']),
                                            const SizedBox(width: 24),
                                            _buildVitalMetric('SPO2', item['spo2']),
                                          ],
                                        )
                                      ],
